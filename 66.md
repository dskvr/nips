...
- `W` - relay "attributes". Ad-hoc, subjective attributes assigned by relay operators. formatted as `PascalCase`, e.g. `PrivateInbox` or `ProfileIndexer` or `RelayListIndexer`. Maximum `9` values.
